...
Route::prefix('a')->name('admin.')->group(function () {
    ...
    Route::get('/berkala', [\App\Http\Controllers\PostController::class, 'indexpengumuman'])->name('pengumuman.index');
    Route::get('/serta-merta', [\App\Http\Controllers\PostController::class, 'indexproduk'])->name('pengumuman.index');
    Route::get('/dikecualikan', [\App\Http\Controllers\PostController::class, 'berita'])->name('berita.index');
    ...
    Route::get('/setiap-saat', [\App\Http\Controllers\PostController::class, 'pengaduan'])->name('pengaduan.index');
