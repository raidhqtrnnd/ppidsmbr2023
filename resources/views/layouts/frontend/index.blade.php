                    ...
                    <div class="container h-100">
                        <div class="row align-items-center h-100">
                            <div class="col-md-12 text-center">
                                ...
                                <h6 class="slide-title" data-animation-in="slideInLeft">Pemerintah </h6>
                                <p data-animation-in="slideInLeft" data-duration-in="1.2">
                                    <a href="https://satpolpp.sumbarprov.go.id/" class="slider btn btn-primary"
                                        style="align:center">Lihat</a>
                                </p>
                            </div>
                        </div>
                    </div>
            ...
            <div class="banner-carousel-item" style="background-image:url({{ asset('frontend/images/news/berita2.jpg') }})">
                <div class="slider-content text-left">
                    <div class="container h-100">
                        <div class="row align-items-center h-100">
                            <div class="col-md-12">
                                <h2 class="slide-title-box" data-animation-in="slideInDown">Pemerintah </h2>
                                <h3 class="slide-sub-title" data-animation-in="slideInLeft">Website Resmi PPID</h3>
                                <p data-animation-in="slideInRight">
                                    <a href="https://satpolpp.sumbarprov.go.id/" class="slider btn btn-primary"
                                        aria-label="contact-with-us">Lihat</a>
                                </p>
                            </div>
                        </div>
                    </div>
