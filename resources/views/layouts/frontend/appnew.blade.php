...
================================================== -->
    ...
    <!-- Favicons -->
    <link href="{{ asset('backend2/assets/img/Lambang_Kota_ .png') }}" rel="icon">
    <link href="{{ asset('backend2/assets/img/Lambang_Kota_ .png') }}" rel="apple-touch-icon">
...
================================================== -->
  ...
  <link rel="stylesheet" href="{{ asset ('frontend/plugins/colorbox/colorbox.css')}}"> --}}
    ...
    <!-- CSS Libraries -->
    <link rel="stylesheet"
        href="{{ asset('frontend/dist/assets/modules/owlcarousel2/dist/assets/owl.carousel.min.css') }}">
    <link rel="stylesheet"
        href="{{ asset('frontend/dist/assets/modules/owlcarousel2/dist/assets/owl.theme.default.min.css') }}">
...
<body onload="loader()">
  ...
  ================================================== -->
    ...
    {{-- <script id="aioa-adawidget"
        src="https://www.skynettechnologies.com/accessibility/js/all-in-one-accessibility-js-widget-minify.js?colorcode=#d1202f&token=&position=bottom_left">
    </script> --}}
