                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="banner-heading">
                                <h1 class="banner-title">Transparansi Anggaran</h1>
                                <nav aria-label="breadcrumb">
                                    <ol class="breadcrumb justify-content-center">
                                        <li class="breadcrumb-item"><a href="#">Transparansi Anggaran </a></li>
                                    </ol>
                                </nav>
                            </div>
                        </div><!-- Col end -->
                                    ...
                                    <h1 class="entry-title">
                                        @if ($profile != null)
                                            <a href="news-single.html">
                                                <h2 style="margin-top:-35px;">{{ $profile->title }}</h2>
                                            </a>
                                    </h1>
                                </div><!-- header end -->
                                ...
                                @else
                                    ...
                                    @foreach ($berkas as $data)
                                        @if ($data->jenis_file == 'gambar')
                                            ...
                                            <img src="{{ route('menu.file', encrypt($data->path_file)) }}" class="img-fluid"
                                                style="width: 100%;">
                                        @endif
                                    @endforeach
                                    <br>
                                        ...
                                        @if ($data->jenis_file == 'lampiran')
                                            ...
                                            <div class="sidebar sidebar-right">
                                                <div class="widget recent-posts">
                                                    <h3 class="widget-title" style="margin-left:-20px; font-size: 25px;">
                                                        Lampiran</h3>
                                                </div>
                                            </div>
                                            <!-- <a href="{{ route('menu.file', encrypt($data->path_file)) }}" target="_blank" style="color: blue;">{{ $data->path_file }}</a> -->
                                            <iframe src="{{ route('menu.file', encrypt($data->path_file)) }}"
                                                name="iframe_a" width="100%" height="600"
                                                style="border:1px solid black;"></iframe> <br><br>
                                            <a href="{{ route('menu.file', encrypt($data->path_file)) }}" target="_blank">
                                                <button class="btn btn-info" style="border-radius: 20px;">Download
                                                    File</button></a><br><br>
                                        @endif
                                    @endforeach
                        ...
                        <div class="sidebar sidebar-right">
                            <div class="sidebar-item search-form">
                                ...
                                <form action="{{ route('reader.search.berita') }}" method="POST" class="mt-3"
                                    ...
                                    <input type="submit" value="Search" style="color:white;"><i
