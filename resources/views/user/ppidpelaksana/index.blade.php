            ...
            <div class="banner-text">
                <div class="container">
                    <div class="row">
                      ...
                      <li class="breadcrumb-item"><a href="#">Data Profil</a></li>
                    </ol> --}}
                                </nav>
                            </div>
                        </div><!-- Col end -->
                                ...
                                <div class="entry-header">
                                    <h1 class="entry-title">
                                        <a href="news-single.html">
                                            <h2 style="margin-top:-35px;">{{ $title }}</h2>
                                        </a>
                                    </h1>
                                </div><!-- header end -->
                                        ...
                                        <table class="table display table-bordered table-striped">
                                            <thead>
                                                <tr style="background-color: #ccd1d1;">
                                                    ...
                                                    <th scope="col" width="220px" style="text-align:center;">Nama OPD
                                                    </th>
                                                    <th scope="col" width="200px" style="text-align:center;">Alamat</th>
                                                    <th scope="col" width="180px" style="text-align:center;">No Tlp/Fax
                                                    </th>
                                                </tr>
                                            </thead>
                                            <tbody>
                        ...
                        <div class="sidebar sidebar-right">
                            <div class="sidebar-item search-form">
                                ...
                                <form action="{{ route('reader.search.berita') }}" method="POST" class="mt-3"
                                    ...
                                    <input type="submit" value="Search" style="color:white; width:75px;"><i
