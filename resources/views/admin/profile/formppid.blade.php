                                            ...
                                            <div class="card"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide" action="{{ route('profilppid.create') }}"
                                                            method="POST" enctype="multipart/form-data">
                                                            {{ csrf_field() }}

                                                            <div class="form-group row">
                                                                <label class="col-lg-8 col-form-label"
                                                                    for="kategori_profile">Nama Kategori</label>
                                                                <div class="col-sm-12">
                                                                    <input type="text" class="form-control"
                                                                        id="kategori_profile" name="kategori_profile"
                                                                        required=""
                                                                        value="{{ $profile->kategori_profile }}" disabled>
                                                                    <input type="hidden" class="form-control"
                                                                        name="kategori_profile"
                                                                        value="{{ $profile->kategori_profile }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                ...
                                                <textarea class="summernote" name="profile">{{ $profile->title }}</textarea>
                                                            ...
                                                            <table class="table table-striped table-md">
                                                                ...
                                                                @foreach ($documents as $data)
                                                                    ...
                                                                    <td style=" text-align:center;">
                                                                        <a
                                                                            href="{{ route('admin.destroy_berkasppid', encrypt($data->id)) }}">
                                                                            <button type="button"
