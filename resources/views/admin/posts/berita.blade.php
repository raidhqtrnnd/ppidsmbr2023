                        ...
                        <section class="section">
                            <div class="section-header">
                                ...
                                <div class="section-header-breadcrumb">
                                    ...
                                    <div class="breadcrumb-item"><a href="#">Informasi Dikecualikan</a></div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-sm-14">
                                            <div class="card"
                                                ...
                                                <div class="card-body">
                                                    <h4 class="card-title">Informasi Dikecualikan</h4>
                                                    <br>
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="display table table-striped table-hover"
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th>No</th>
                                                                    <th style="width:220px; text-align:center;">Judul Berita
                                                                    </th>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    @foreach ($posts as $data)
                                                                        ...
                                                                        <td>
                                                                            @if ($data->ispinned == '1')
                                                                                <div class="badge badge-danger"
                                                                                    style="margin-top:5px;">Pinned</div>
                                                                            @else
                                                                                -
                                                                            @endif
                                                                        </td>
                                                                        <td> {{ date('d F Y', strtotime($data->tgl_post)) }}
                                                                        </td>
                                                                        ...
                                                                        <td>
                                                                            @if ($data->thumbnail == null)
                                                                                -
                                                                            @else
                                                                                <img src="{{ route('file.show', encrypt($data->thumbnail)) }}"
                                                                                    class="img-fluid" style="width: 100px">
                                                                            @endif
                                                                        </td>
                                                                        <td>
                                                                            <form
                                                                                action="{{ route('admin.post.destroy', $data->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <a href="{{ route('admin.post.show', $data->id) }}"
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    onclick="return confirm('Konfirmasi hapus data postingan ?')"><i
