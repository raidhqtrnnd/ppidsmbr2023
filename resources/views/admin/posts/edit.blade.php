                        ...
                        <section class="section">
                            ...
                            <div class="content-body">
                                ...
                                <div class="container-fluid">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide"
                                                            action="{{ route('admin.post.update', $posts->id) }}"
                                                            method="POST" enctype="multipart/form-data">
                                                            {{ csrf_field() }}
                                                            @method('PATCH')
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label" for="judul">Judul
                                                                    Berita</label>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <label class="custom-switch mt-2">
                                                                        <input type="checkbox" name="status_publish"
                                                                            ...
                                                                            @if ($posts->ispublish == '1') checked @endif>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <label class="custom-switch mt-2">
                                                                        <input type="checkbox" name="status_pinned"
                                                                            class="custom-switch-input"
                                                                            @if ($posts->ispinned == '1') checked @endif>
                                                                        <span class="custom-switch-indicator"></span>
                                                                        <span class="custom-switch-description">Berita akan
                                                                ...
                                                                <select class="form-control" name="kategori_id" required>
                                                                    ...
                                                                    @foreach ($kategori as $data)
                                                                        <option value="{{ $data->id }}"
                                                                            @if ($posts->kategori_id == $data->id) selected @endif>
                                    ...
                                    @if ($data->id == $value->id) selected @endif @endforeach>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <textarea class="summernote" style="height:10px;" name="contents" class="form-control" placeholder="Konten Berita">{!! $posts->contents !!}</textarea>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                @foreach ($documents as $data)
                                                                    ...
                                                                    <td style=" text-align:center;">
                                                                        @if ($data->jenis_file == 'gambar')
                                                                            <img src="{{ route('file.show', encrypt($data->path_file)) }}"
                                                                    ...
                                                                    <td style=" text-align:center;">
                                                                        @if ($data->jenis_file == 'gambar')
                                                                            <a target="_blank"
                                                                                href="{{ route('file.show', encrypt($data->path_file)) }}"><button
                                                                                    type="button"
                                                                    ...
                                                                    <td style=" text-align:center;">
                                                                        <a
                                                                            href="{{ route('admin.destroy_document', encrypt($data->id)) }}">
                                                                            <button type="button"
                                                                                class="btn btn-danger btn-xs"><i
                                                                                    class="fas fa-trash icon-lg"></i>
                                                                                Hapus</button></a>
                                                                    </td>
                                                                    </tr>
                                                                @endforeach
                                                        ...
                                                        <a href="{{ route('admin.post.index') }}"><button
                                                                class="btn btn-info"><i class="fa fa-undo"
