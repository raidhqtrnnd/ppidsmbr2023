    ...
    <div class="body-inner">
        ...
        <div class="px-2 bg-light">
            <marquee class="py-3" direction="left" onmouseover="this.stop()" onmouseout="this.start()" scrollamount="10"
                behavior="scroll">
                <h6 style="color: #ffb600; font-size: 18px;">Halaman Pratinjau Berita Website PPID </h6>
            </marquee>
        </div>
                    ...
                    <div class="col-lg-8 mb-5 mb-lg-0">
                            ...
                            <div class="post-body">
                                <div class="entry-header">
                                    <div class="post-meta">
                                        ...
                                        <span class="post-cat">
                                            <i class="far fa-folder-open"></i><a href="#">
                                                {{ $detail->kategori->nama_kategori }}</a>
                                        </span>
                                        <span class="post-comment"><i class="far fa-calendar"></i>
                                            <a href="#" class="comments-link">
                                                {{ date('d M Y', strtotime($detail->tgl_post)) }}</a></span>
                                    </div>
                                ...
                                <div class="post-content post-single">
                                    <div class="post-media post-image">
                                        ...
                                        @else
                                            <img loading="lazy" src="{{ route('menu.file', encrypt($detail->thumbnail)) }}"
                                                class="img-fluid" style="text-align: center;" alt="thumbnail Default"> <br>
                                        @endif
                                    </div>
                                    ...
                                    <div class="sidebar sidebar-right">
                                        <div class="widget recent-posts">
                                            <h3 class="widget-title" style="margin-left:-20px; font-size: 25px;">Lampiran
                                            </h3>
                                        </div>
                                    </div>
                        ...
                        @if ($files != null)
                            @foreach ($files as $file)
                                <iframe src="{{ route('menu.file', encrypt($file->path_file)) }}" name="iframe_a"
                                    width="100%" height="600" style="border:1px solid black;"></iframe> <br>
                                <a href="{{ route('menu.file', encrypt($file->path_file)) }}" target="_blank"> <button
                                        class="btn btn-info" style="border-radius: 20px; margin-top:15px;">Download
                                        File</button></a><br><br>
                            @endforeach
                        @endif
                    ...
                    <div class="sidebar-item search-form">
                        ...
                        <form action="{{ route('reader.search.berita') }}" method="POST" class="mt-3"
                            ...
                            <input type="text" value="{{ old('cari') }}" name="cari"
                                style="padding-right:10px; padding-left:10px;"> <input type="submit" value="Search"
                                style="color:white;"><i class="bi bi-search"></i></input>
                        </form>
                                ...
                                <li class="d-flex align-items-center">
                                    <div class="posts-thumb">
                                        <a href="#"><img loading="lazy" alt="img"
                                                src="{{ route('menu.file', encrypt($data->thumbnail)) }}"></a>
                                    </div>
                                    <div class="post-info">
