                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" id="judul" name="judul"
                                                                        ...
                                                                        placeholder="Judul" value="{{ $youtube->judul }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" id="link" name="link"
                                                                        class="form-control" required=""
                                                                        placeholder="Link" value="{{ $youtube->link }}">
                                                                    <span style="color: #ff0000; font-size: 12px">*Format
                                                                        link :
                                                                        https://www.youtube.com/embed/eCthuzNClSs</span>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label"
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <label class="custom-switch mt-2">
                                                                        <input type="checkbox" name="status_publish"
                                                                            ...
                                                                            @if ($youtube->ispublish == '1') checked @endif>
                                                                        <span class="custom-switch-indicator"></span>
                                                                        <span class="custom-switch-description">Video
                                                                            youtube akan terlihat secara umum di halaman
                                                                            utama</span>
                                                                    </label>
                                                                </div>
                                                            </div>
