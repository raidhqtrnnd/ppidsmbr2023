                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide"
                                                            ...
                                                            <div class="form-group row">
                                                                <label class="col-lg-8 col-form-label" for="jenis_tag">Jenis
                                                                    Tags</label>
                                                                <div class="col-sm-12">
                                                                    <input type="text" id="jenis_tag" name="jenis_tag"
                                                                        class="form-control" required=""
                                                                        value="{{ $tags->jenis_tag }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label"
                                                                    for="isaktif">Status</label>
                                                                <div class="col-sm-12">
                                                                    <select class="form-control" name="isaktif"
                                                                        value="{{ $tags->isaktif }}">
                                                                        @if ($tags->isaktif == 1)
                                                                            <option value="{{ $tags->isaktif }}" selected>
                                                                                Aktif</option>
                                                                        @elseif ($tags->isaktif == 0)
                                                                            <option value="{{ $tags->isaktif }}" selected>
                                                                                Tidak Aktif</option>
                                                                        @endif
