                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-sm-10">
                                            <div class="card"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide"
                                                            action="{{ route('information.create') }}" method="POST"
                                                            enctype="multipart/form-data">
                                                            {{ csrf_field() }}

                                                            <div class="form-group row">
                                                                <label class="col-lg-8 col-form-label"
                                                                    for="kategori_informasi">Nama Kategori</label>
                                                                <div class="col-sm-12">
                                                                    <input type="text" class="form-control"
                                                                        id="kategori_informasi" name="kategori_informasi"
                                                                        required=""
                                                                        value="{{ $information->kategori_informasi }}"
                                                                        disabled>
                                                                    <input type="hidden" class="form-control"
                                                                        name="kategori_informasi"
                                                                        value="{{ $information->kategori_informasi }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" name="deskripsi">{{ $information->deskripsi }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-12">
                                                    <textarea class="summernote" name="profile">{{ $information->title }}</textarea>
                                                </div>
                                            </div> -->
                                                            <hr>
                                                            ...
                                                            <table class="table table-striped table-md">
                                                                ...
                                                                @foreach ($documents as $data)
                                                                    ...
                                                                    <td style=" text-align:center;">
                                                                        <a
                                                                            href="{{ route('admin.destroy_berkas_informasi', encrypt($data->id)) }}">
                                                                            <button type="button"
