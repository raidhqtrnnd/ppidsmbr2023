                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide"
                                                            action="{{ route('informasi_publik.daftar_informasi.pelaksana.create') }}"
                                                            method="POST" enctype="multipart/form-data">
                                                            {{ csrf_field() }}

                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label" for="ppid">PPID
                                                                    Pembantu</label>
                                                                <div class="col-sm-12">
                                                                    <input type="text" id="ppid" name="ppid"
                                                                        class="form-control" required=""
                                                                        placeholder="PPID Pembantu"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label"
                                                                    for="link">Link</label>
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" style="height:10px;" name="link" class="form-control" required="" placeholder="Link"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
