                                            ...
                                            <div class="card"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="card-tools">
                                                        <br>
                                                        <a href="{{ route('informasi_publik.daftar_informasi.pelaksana.create') }}"
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="display table table-striped table-hover"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    @foreach ($informasi_ppid as $p)
                                                                        <td>{{ $p->id }}</td>
                                                                        <td>{{ $p->ppid }}</td>
                                                                        <td>{!! $p->link !!}</td>
                                                                        <td>
                                                                            <form
                                                                                action="{{ route('informasi_publik.daftar_informasi.pelaksana.destroy', $p->id) }}"
                                                                                method="POST">
                                                                                <a href="{{ route('informasi_publik.daftar_informasi.pelaksana.edit', $p->id) }}"
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    onclick="return confirm('Konfirmasi hapus Daftar Informasi Publik PPID Pelaksana?')"><i
