                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide"
                                                            action="{{ route('informasi_publik.daftar_informasi.pelaksana.edit', $informasi_ppid->id) }}"
                                                            method="POST" enctype="multipart/form-data">
                                                            {{ csrf_field() }}

                                                            <div class="form-group row">
                                                                <label class="col-lg-8 col-form-label" for="ppid">PPID
                                                                    Pembantu</label>
                                                                <div class="col-sm-12">
                                                                    <input type="text" id="ppid" name="ppid"
                                                                        class="form-control" required=""
                                                                        value="{{ $informasi_ppid->ppid }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label"
                                                                    for="link">Link</label>
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" name="link" class="form-control" required="" placeholder="Link">{!! $informasi_ppid->link !!}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
