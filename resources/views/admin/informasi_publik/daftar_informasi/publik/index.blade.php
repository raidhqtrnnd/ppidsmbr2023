                                            ...
                                            <div class="card"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="card-tools">
                                                        <br>
                                                        <a href="{{ route('informasi_publik.daftar_informasi.publik.create') }}"
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="display table table-striped table-hover"
                                                            ...
                                                            <thead>
                                                                <tr>
                                                                    <th>No.</th>
                                                                    <th>Daftar Informasi dan Dokumentasi Publik</th>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    @foreach ($informasi_publik as $pb)
                                                                        <td>{{ $pb->id }}</td>
                                                                        <td>{!! $pb->daftar_informasi !!}</td>
                                                                        <td>{!! $pb->ringkasan !!}</td>
                                                                        <td>{{ $pb->jenis }}</td>
                                                                        <td>{{ $pb->jangka_waktu }}</td>
                                                                        <td>{!! $pb->link !!}</td>
                                                                        <td>
                                                                            <form
                                                                                action="{{ route('informasi_publik.daftar_informasi.publik.destroy', $pb->id) }}"
                                                                                method="POST">
                                                                                <a href="{{ route('informasi_publik.daftar_informasi.publik.edit', $pb->id) }}"
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    onclick="return confirm('Konfirmasi hapus Daftar Informasi Publik ?')"><i
