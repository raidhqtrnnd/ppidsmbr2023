                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide"
                                                            action="{{ route('informasi_publik.daftar_informasi.publik.create') }}"
                                                            method="POST" enctype="multipart/form-data">
                                                            {{ csrf_field() }}

                                                            <div class="form-group row">
                                                                <label class="col-lg-8 col-form-label"
                                                                    for="daftar_informasi">Daftar Informasi dan Dokumentasi
                                                                    Publik</label>
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" name="daftar_informasi" class="form-control" required="" placeholder="Daftar Informasi"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label"
                                                                    for="ringkasan">Ringkasan Informasi</label>
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" name="ringkasan" class="form-control" required="" placeholder="Ringkasan"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label" for="jenis">Jenis
                                                                    Informasi</label>
                                                                <div class="col-sm-12">
                                                                    <input type="text" id="jenis" name="jenis"
                                                                        class="form-control" required=""
                                                                        placeholder="Jenis Informasi"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label"
                                                                    for="jangka_waktu">Jangka Waktu</label>
                                                                <div class="col-sm-12">
                                                                    <input type="text" id="jangka_waktu"
                                                                        name="jangka_waktu" class="form-control"
                                                                        required=""
                                                                        placeholder="Jangka Waktu"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label"
                                                                    for="link">Link</label>
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" style="height:10px;" name="link" class="form-control" required=""
