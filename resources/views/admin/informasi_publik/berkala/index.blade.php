                                            ...
                                            <div class="card"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="card-tools">
                                                        <br>
                                                        <a href="{{ route('informasi_publik.berkala.create') }}"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    @foreach ($informasi_berkala as $b)
                                                                        ...
                                                                        <td>
                                                                            <form
                                                                                action="{{ route('informasi_publik.berkala.destroy', $b->id) }}"
                                                                                method="POST">
                                                                                <a href="{{ route('informasi_publik.berkala.edit', $b->id) }}"
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    onclick="return confirm('Konfirmasi hapus Daftar Informasi Secara Berkala?')"><i
