                                            ...
                                            <div class="card"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="card-tools">
                                                        <br>
                                                        <a href="{{ route('informasi_publik.serta_merta.create') }}"
                                                    ...
                                                    <div class="table-responsive">
                                                        <table class="display table table-striped table-hover"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    @foreach ($informasi_serta_merta as $sm)
                                                                        <td>{{ $sm->id }}</td>
                                                                        <td>{{ $sm->judul }}</td>
                                                                        <td>{!! $sm->isi !!}</td>
                                                                        <td>
                                                                            <form
                                                                                action="{{ route('informasi_publik.serta_merta.destroy', $sm->id) }}"
                                                                                method="POST">
                                                                                <a href="{{ route('informasi_publik.serta_merta.edit', $sm->id) }}"
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    onclick="return confirm('Konfirmasi hapus Daftar Informasi Serta Merta?')"><i
