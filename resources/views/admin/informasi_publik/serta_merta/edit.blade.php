                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide"
                                                            action="{{ route('informasi_publik.serta_merta.edit', $informasi_serta_merta->id) }}"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" id="judul" name="judul"
                                                                        ...
                                                                        value="{{ $informasi_serta_merta->judul }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label"
                                                                    for="isi">Isi</label>
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" name="isi" class="form-control" required="" placeholder="Isi">{!! $informasi_serta_merta->isi !!}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
