                                            ...
                                            <div class="card"
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="card-tools">
                                                        <br>
                                                        <a href="{{ route('informasi_publik.setiap_saat.create') }}"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    @foreach ($informasi_setiap_saat as $ss)
                                                                        ...
                                                                        <td>
                                                                            <form
                                                                                action="{{ route('informasi_publik.setiap_saat.destroy', $ss->id) }}"
                                                                                method="POST">
                                                                                <a href="{{ route('informasi_publik.setiap_saat.edit', $ss->id) }}"
                                                                                ...
                                                                                <button type="submit"
                                                                                    ...
                                                                                    onclick="return confirm('Konfirmasi hapus Daftar Informasi Setiap Saat?')"><i
