                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide"
                                                            action="{{ route('admin.icons.update', $icons->id) }}"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <input type="text" name="judul" class="form-control"
                                                                    placeholder="Judul" value="{{ $icons->judul }}" />
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label" for="subjudul">Sub
                                                                    Judul</label>
                                                                <input type="text" name="subjudul" class="form-control"
                                                                    placeholder="Sub Judul"
                                                                    value="{{ $icons->subjudul }}" />
                                                            </div>
                                                            <div class="form-group row">
                                                            ...
                                                            <div class="form-group row">
                                                                <select class="form-control" name="kategori_name" required>
                                                                    <option value="{{ $icons->kategori_name }}"
                                                                        @if ($icons->kategori_name == 'carousel') selected @endif>
                                                                        {{ $icons->kategori_name }}</option>
                                                        ...
                                                        <a href="{{ route('admin.icons.index') }}"><button
