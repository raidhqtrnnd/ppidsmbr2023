                                                                ...
                                                                <tr>
                                                                    ...
                                                                    @foreach ($permohonan as $data)
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            @else
                                                                                <a href="#" class="pop">
                                                                                    <img src="{{ route('file.show', encrypt($data->ktp)) }}"
                                                                                        class="img-fluid"
                                                                                        style="width: 100px">
                                                                                </a>
                                                                            @endif
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            @else
                                                                                <a href="#" class="pop">
                                                                                    <img src="{{ route('file.show', encrypt($data->akta)) }}"
                                                                                        class="img-fluid"
                                                                                        style="width: 100px">
                                                                                </a>
                                                                            @endif
                                                                            ...
                                                                            @if ($data->status_form == '1')
                                                                                <strong>
                                                                                    <p
                                                                                        ...
                                                                                        Menunggu Tindak Lanjut</p>
                                                                                </strong>
                                                                            @elseif($data->status_form == '2')
                                                                                <strong>
                                                                                    <p
                                                                                        style="color:purple;  font-weight: bold;">
                                                                                        Proses Tindak Lanjut</p>
                                                                                </strong>
                                                                            @elseif($data->status_form == '3')
                                                                                <strong>
                                                                                    <p
                                                                                        style="color:green;  font-weight: bold;">
                                                                                        Selesai Tindak Lanjut</p>
                                                                                </strong>
                                                                            @elseif($data->status_form == '4')
                                                                                <strong>
                                                                                    <p
                                                                                        style="color:red;  font-weight: bold;">
                                                                                        Tidak bisa Ditindaklanjuti</p>
                                                                                </strong>
                                                                            @else
                                                                                -
                                                                            @endif
                                                                        ...
                                                                        <td>
                                                                            <button type="button"
                                                                                class="btn btn-warning validasi"
                                                                                data-toggle="modal"
                                                                                data-catatan="{{ $data->catatan_validasi }}"
                                                                                data-status="{{ $data->status_form }}"
                                                                                data-id="{{ $data->id }}"
                                                                                data-nama="{{ $data->nama_lengkap }}"
                                                                                data-target="#validasimodal"><i
                                                                                    class="fas fa-check"></i>
                                                                                Validasi</button><br><br>

                                                                            <form
                                                                                action="{{ route('destroy_permohonan', $data->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit"
                                                                                    class="btn btn-danger"
                                                                                    onclick="return confirm('Konfirmasi hapus data permohonan user ?')"><i
