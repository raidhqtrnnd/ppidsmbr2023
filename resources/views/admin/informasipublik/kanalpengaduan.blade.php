...
<head>
    ...
    <title>Kanal Pengaduan | PPID </title>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide"
                                                            action="{{ route('admin.kanalpengaduan.update') }}"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <input type="text" class="form-control"
                                                                        ...
                                                                        required=""
                                                                        value="{{ $pengaduan->kategori_profile }}"
                                                                        disabled>
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" name="deskripsi">{{ $pengaduan->deskripsi }}</textarea>
                                                                </div>
                                                            </div>
