                        ...
                        <section class="section">
                            <div class="section-header">
                                ...
                                <div class="section-header-breadcrumb">
                                    ...
                                    <div class="breadcrumb-item"><a href="#">Pengajuan</a></div>
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    @foreach ($pengajuan as $data)
                                                                        ...
                                                                        <td>
                                                                            <form
                                                                                action="{{ route('destroy_pengajuan', $data->id) }}"
                                                                                method="POST">
                                                                                @csrf
                                                                                @method('DELETE')
                                                                                <button type="submit"
                                                                                    class="btn btn-danger"
                                                                                    onclick="return confirm('Konfirmasi hapus data pengajuan keberatan user ?')"><i
