                    ...
                    <div class="main-content">
                        <section class="section">
                            <div class="section-header">
                                <h1>Dashboard Sistem Informasi PPID </h1>
                            </div>
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6 col-12">
                                    <div class="card card-statistic-1">
                                        ...
                                        <div class="card-wrap">
                                            <div class="card-header">
                                                <h4>Total Kategori Informasi</h4>
                                            </div>
                                            <div class="card-body">
                                                {{ $categories }}
                                            </div>
                            ...
                            {{-- <div class="row">
                                <div class="col-xl-6">
                                    <div class="card mb-4" style="background-color: #d4c7b4; margin-left:-12px;">
                                        <div class="card-header">
                                            <i class="fas fa-chart-area me-1"></i><b style="margin-left:5px;"> Jumlah Berita
                                                Ter-Publish Per Bulan</b>
                                        </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        document.getElementById('logout-form').submit();"><i
                            ...
                            <button class="btn btn-danger" type="button" data-dismiss="modal"><i class="fas fa-times"></i>
                                TIDAK</button>
