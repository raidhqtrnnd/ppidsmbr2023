                        ...
                        <section class="section">
                            <div class="section-header">
                                ...
                                <div class="section-header-breadcrumb">
                                    ...
                                    <div class="breadcrumb-item"><a href="#">Data Profil</a></div>
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide"
                                                            action="{{ route('ppidpelaksana.store') }}" method="POST"
                                                            enctype="multipart/form-data">
                                                            {{ csrf_field() }}

                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label" for="nama_opd">Nama
                                                                    OPD</label>
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" name="nama_opd" class="form-control" required="" placeholder="Nama OPD"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" name="alamat" class="form-control" required="" placeholder="Alamat"></textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label"
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" style="height:10px;" name="telepon" class="form-control" required=""
