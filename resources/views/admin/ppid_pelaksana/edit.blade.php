                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="form-validation">
                                                        <form class="form-valide"
                                                            action="{{ route('ppidpelaksana.update', $ppid_pelaksana->id) }}"
                                                            ...
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" name="alamat" class="form-control" required="" placeholder="Alamat">{!! $ppid_pelaksana->alamat !!}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
                                                                <label class="col-lg-6 col-form-label"
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <textarea class="summernote" style="height:10px;" name="telepon" class="form-control" required=""
                                                                        placeholder="Nomor Telepon">{!! $ppid_pelaksana->telepon !!}</textarea>
                                                                </div>
                                                            </div>
                                                            <div class="form-group row">
